...
def hero_banner():
    ...
    <div class="hero-box">
        ...
        <div class="hero-chip">Prototype ringan - Hari ke-6</div>
    </div>
    """, unsafe_allow_html=True)
...
def ringkasan_terakhir(df_logbook, df_mahasiswa):
    ...
    return ringkasan[[
        "nama", "divisi", "tanggal", "progres", "kehadiran", "kendala", "pembimbing"
    ]]
    ...
    for _, row in df_ai.iterrows():
        ...
        <div class="student-card">
            <div class="student-header">
                ...
                <div>{render_status_badge(row["status_ai"])}</div>
            </div>
...
menu = st.sidebar.radio(
    "Pilih halaman",
    ["Dashboard", "Input Logbook", "Analisis AI", "Data Lengkap"]
)

st.sidebar.markdown("---")
st.sidebar.write("**Identitas warna:** Maroon & Putih")
st.sidebar.write("**Tahap project:** Hari ke-6")
st.sidebar.write("**Fokus:** Design dasar")
...
if menu == "Dashboard":
    ...
    st.markdown("<div class='small-note'>Tampilan dashboard sudah mulai diarahkan ke gaya identitas kampus.</div>", unsafe_allow_html=True)
    ...
    if not df_logbook_olah.empty:
        ...
        with col_g2:
            ...
            laporan_per_mahasiswa = (
                df_logbook_olah.groupby("nama")
                .size()
                .sort_values(ascending=False)
            )
...
# =========================
    ...
    if not df_ai.empty:
        ...
        st.markdown("<div class='small-note'>Bagian ini adalah inti unsur AI pada prototype kamu.</div>", unsafe_allow_html=True)
